...
__export(vite_exports, {
  ...
  allstakVitePlugin: () => allstakVitePlugin
});
...
function allstakVitePlugin(opts = {}) {
  let resolvedDir = opts.dir ? (0, import_node_path4.resolve)(opts.dir) : void 0;
  let lastReport = null;
  return {
    ...
    configResolved(config) {
      ...
      resolvedDir = (0, import_node_path4.resolve)(root, outDir);
    },
    async closeBundle() {
