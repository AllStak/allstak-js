...
- Added top-level `mechanism` and `handled` fields to error payloads so handled
  captures, browser unhandled errors, Node uncaught exceptions, and unhandled
  rejections classify correctly in the AllStak backend and dashboard.
